...
```{r}
 ...
 Harry_Potter %>% arrange(desc(rating))
 Harry_Potter %>% arrange(desc(votes))    
```

The movies included in the data are Harry Potter and the Sorcerer's Stone, Harry Potter and the Chamber of Secrets, Harry Potter and the Prisoner of Azkaban. Harry Potter and the Prisoner of Azkaban had the highest rating while Harry Potter and the Sorcerer's Stone had the most votes. 
...
movies101 <- movies %>%
 ...
 arrange(desc(budget))
print(movies101$budget)
```

The highest budget is 170000000 for a movie that is Animation or Comedy with at least 100 votes.
...
My favorite movie was not in the data set. Another question we could ask is Which Lord of the Rings had the lowest rating? which had the lowest votes. This question would require that we filter the title "Lord of the Rings", then select ratings and votes, and lastly arrange them by descending order.
